...
namespace MeetingService.UnitiesOfWork
{
    public class UnitOfWork : IUnitOfWork
    {
        ...
        private IParticipantRoleRepository _roleRepository;
        public IParticipantRoleRepository RoleRepository { get { _roleRepository ??= new ParticipantRoleRepository(_context); return _roleRepository; } }
